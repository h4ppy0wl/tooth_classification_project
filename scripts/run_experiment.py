...
def main():
    ...
    experiment_params = [
        ...
        {"MASK_VALUE": 128, "AUGMENT_DATA": True, "NORMALIZE_IMAGES": True,  "MASK_BG": True, "HEAD_DENSE_UNITS": 128, "MODEL_ARCHITECTURE": 'custom_v1', 'FINE_TUNE_FROM_LAYER': 143, 'HEAD_ARCHITECTURE': "deep"}#"moderate"},
    ...
    for params in experiment_params:
        ...
        csv_fields = [
            ...
            "weight_file", "initial_history_file", "fine_tune_history_file", 'FINE_TUNE_FROM_LAYER','HEAD_ARCHITECTURE'
        ]
