...
def main():
    ...
    # experiment_params = [
    #     {"MASK_VALUE": 128, "AUGMENT_DATA": True, "NORMALIZE_IMAGES": True,  "MASK_BG": True, "HEAD_DENSE_UNITS": 128, "MODEL_ARCHITECTURE": 'vgg16', 'FINE_TUNE_FROM_LAYER': 15, 'HEAD_ARCHITECTURE': "shallow_combo"},
    ...
    for params in experiment_params:
        ...
        experiment_log_dir_path = os.path.join(config.LOG_DIR, "tensorboard")
        log_dir_path = os.path.join(experiment_log_dir_path, config.MODEL_ARCHITECTURE)
        os.makedirs(log_dir_path, exist_ok=True)
        # CSV file to collect results.
        csv_file = os.path.join(experiment_log_dir_path, "experiment_results.csv")
        ...
        csv_fields = [
            ...
            "weight_file", "initial_history_file", "fine_tune_history_file", 'FINE_TUNE_FROM_LAYER',
            'HEAD_ARCHITECTURE', 'TAP_INTO_BASE_MODEL', 'NUM_FINE_TUNE_EPOCHS'
        ]
        ...
        result_row = {
            ...
            'FINE_TUNE_FROM_LAYER': params.get('FINE_TUNE_FROM_LAYER'),
            'HEAD_ARCHITECTURE': params.get('HEAD_ARCHITECTURE'),
            'TAP_INTO_BASE_MODEL': params.get('TAP_INTO_BASE_MODEL'),
            'NUM_FINE_TUNE_EPOCHS': params.get('NUM_FINE_TUNE_EPOCHS'),
